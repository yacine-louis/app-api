...
class ChangeSectionRequest(BaseModel):
    ...
    change_section_request_id = db.Column(db.Integer, primary_key=True, autoincrement=True, nullable=False)
    ...
    def to_dict(self):
        return {
            'change_section_request_id': self.change_section_request_id,
